            ...
            if (version === 'D' && datos.email_directivo && !demo) {
              ...
              if (dominio && !DOMINIOS_GENERICOS.has(dominio)) {
                ...
                if (dominioExistente && dominioExistente.length > 0) {
                  ...
                  setErrorEmail(
                    'Su empresa ya está registrada en el estudio con el código ' + codExistente + '. ' +
                    'Utilice el enlace https://bev-pymes-cuestionario.vercel.app/empresa/' + codExistente +
                    ' para acceder y añadir su respuesta como directivo adicional.'
                  )
                  return
                }
              }
